tellraw @a[tag=logs] [{"color":"white","text":"running function "},{"color":"green","text":"save_sys:load_level_items"},{"color":"white","text":" with {}"}]
...
item replace entity @s armor.head from block ~-1 ~ ~ container.18
item replace entity @s armor.chest from block ~-1 ~ ~ container.19
item replace entity @s armor.legs from block ~-1 ~ ~ container.20
item replace entity @s armor.feet from block ~-1 ~ ~ container.21
item replace entity @s weapon.offhand from block ~-1 ~ ~ container.22

# idk you just dont get these i guess
