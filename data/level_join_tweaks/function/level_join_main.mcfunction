...
# load the room
$setblock ~ 0 -48 minecraft:structure_block[mode=load]{author:"ImSorry4YourLoss",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"LOAD",name:"minecraft:$(room_id)",posX:0,posY:0,posZ:48,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:0b,sizeX:48,sizeY:48,sizeZ:48}
setblock ~ 2 -48 minecraft:command_block[conditional=false,facing=up]{Command:"fill ~ ~ ~ ~ ~-2 ~ minecraft:bedrock",SuccessCount:0,TrackOutput:1b,UpdateLastExecution:1b,auto:0b,conditionMet:0b,powered:0b}
